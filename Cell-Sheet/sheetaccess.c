...
نوع: int (عدد صحیح)
، hasDigit یک پرچم (flag) است که نشان می‌دهد آیا در آدرس سلول حداقل یک رقم (عدد) وجود دارد یا خیر.
مقدار اولیه: 0 (false)
...
نوع: int (عدد صحیح)
 hasAlpha یک پرچم (flag) است که نشان می‌دهد آیا در آدرس سلول حداقل یک حرف (حرف الفبا) وجود دارد یا خیر.
مقدار اولیه: 0 (false)
